...
\cleardoublepage\part{Aprendizaje profundo}
\label{part:deep-learning}
\input{capitulos/capitulo-vision-artificial}
\input{capitulos/capitulo-ann}
\input{capitulos/capitulo-conceptos-dl}

\cleardoublepage\part{Análisis de datos topológico para el estudio de CNNs}
\label{part:proposal}
\input{capitulos/capitulo-tda}
